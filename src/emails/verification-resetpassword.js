const getResetPasswordHtml = (otp) => {
  const title = 'Reset your password';
  const description =
    'You requested to reset your password for your Odonto Dental Clinic account. Please use the following One-Time Password (OTP) to continue the password reset process:';
        ...
        <table width="100%" max-width="600" border="0" cellspacing="0" cellpadding="0" style="max-width: 600px; background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 15px rgba(0,0,0,0.05);">
          ...
          <tr>
            <td style="background-color: #1e3a8a; padding: 40px 30px; text-align: center;">
              <h1 style="color: #ffffff; font-size: 28px; margin: 0; font-weight: 700; letter-spacing: 1px;">Odonto Dental Clinic</h1>
            </td>
          </tr>
          <!-- Body -->
          <tr>
          ...
          <tr>
            <td style="background-color: #f9fafb; padding: 30px 40px; border-top: 1px solid #e5e7eb; text-align: center;">
              <p style="color: #9ca3af; font-size: 14px; margin: 0; line-height: 1.5;">
                &copy; ${new Date().getFullYear()} Odonto Dental Clinic. All rights reserved.
              </p>
            </td>
          </tr>
        </table>
...
module.exports = { getResetPasswordHtml };
