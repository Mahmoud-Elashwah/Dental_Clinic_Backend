const getPasswordResetConfirmationEmailHtml = (
  userEmail,
          ...
          <tr>
            <td style="padding: 50px 15px;">
              ...
              <p style="color: #4b5563; font-size: 16px; line-height: 1.6; margin-bottom: 32px;">
                We are writing to confirm that your password for your Odonto Dental Clinic account has been successfully changed.
              </p>
          ...
          <tr>
            <td style="background-color: #f9fafb; padding: 30px 40px; border-top: 1px solid #e5e7eb; text-align: center;">
              <p style="color: #9ca3af; font-size: 14px; margin: 0; line-height: 1.5;">
                &copy; ${new Date().getFullYear()} Odonto Dental Clinic. All rights reserved.<br>
...
module.exports = { getPasswordResetConfirmationEmailHtml };
